<template>
  <div class="deployment-form">
    ...
    <div>
      ...
      <input type="text" v-model="deploymentRequest.object_meta.namespace"
        placeholder="Namespace (default value: default)" />
    </div>
...
export default {
  ...
  methods: {
    ...
    async sendJson() {
      ...
      try {
        await axios.post('/pods', this.deploymentRequest, {
          headers: {
